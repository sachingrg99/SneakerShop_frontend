...
const Image = () => {
  ...
  return (
    <div className={classes.gallery}>
      <Typography variant="h4" align="center" className={classes.galleryH}>Order <span className={classes.spanFood}>Accessories</span></Typography>
      <br />
      <Grow in>
              ...
              <div className={classes.mainSearch} >
                <AppBar className={classes.appBarSearch} position="static" color="inherit">
                  ...
                  <FormControl sx={{ overflow: 'hidden', marginTop: '5px' }}>
                    <InputLabel id="demo-simple-select-helper-label">Accessories Status</InputLabel>
                    <Select
                  ...
                  <Button onClick={searchPost} style={{
                    letterSpacing: '2.5px', backgroundImage: 'linear-gradient(to top,#0a0a0a 0%,#171717 100%)', color: 'white', fontWeight: 'bold', fontSize: '14px', padding: '8px', borderRadius: '5px',
