                    ...
                    <Paper className={classes.paper}>
                        <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmitAbout}>
                            ...
                            {progress ?
                                ...
                                <div style={{ textAlign: "center" }} ><input style={{ padding: '20px 0px', marginLeft: "10px", width:"50%" }} type="file" id='selectedFile' name='selectedFile' onChange={(e) => setimage({ ...image, selectedFile: e.target.files[0] })} />
                                    <Button variant="contained" color="primary" style={{
              display:"inline-block",
              background:"black",
              color:"white"
            }} size="large" onClick={upload}>Upload</Button></div>}
