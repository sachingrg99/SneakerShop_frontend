              ...
              <Container maxWidth='xl' style={{
                ...
                <Zoom>
                  <Routes>
                    ...
                    <Route path="/sneaker/:id" exact element={<PostDetail handleAddProduct={handleAddProduct} />} />
                    <Route path="/accessories/:id" exact element={<PostDetailOfRoom />} />
                    <Route path="/about" exact element={<About />} />
                    <Route path="/auth" exact element={<Auth />} />
                    <Route path="/users/:id/verify/:token" exact element={<Verify />} />
                    <Route path="/sneaker" exact element={<Image />} />
                    <Route path="/sneaker/search" exact element={<Image />} />
                    <Route path="/accessories" exact element={<Room />} />
